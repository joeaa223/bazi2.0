...
const getBrancheNames = (eightChar) => {
    return [
...
export function buildGods(eightChar, gender = 1) {
    var _a;
    const gods = [[], [], [], []]; // 年月日时
    ...
    if ((_a = TIAN_SHE_XING[dayZhu]) === null || _a === void 0 ? void 0 : _a.includes(monthZhi)) {
        gods[1].push('天赦星');
    }

import { DefaultEightCharProvider, LunarSect2EightCharProvider, LunarHour, ChildLimit } from "tyme4ts";
...
export function buildHideHeavenObject(heavenStem, me) {
    if (!heavenStem) {
        return undefined;
    }
    return {
...
export function buildSixtyCycleObject(sixtyCycle, me) {
...
export function buildBazi(options) {

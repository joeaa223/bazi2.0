...
function calculateRelation(zhuObject) {
    const relation = {};
    // 初始化
    ...
    for (const zhu1 in zhuObject) {
        ...
        const seen_combinations = new Set();
...
function getGanChong(gan1, gan2) {
...
function getZhiChong(zhi1, zhi2) {
...
function getHalfSanHe(zhi1, zhi2) {
...
// 判断天干地支是否符合拱、夹关系
function getGongJia(gan1, zhi1, gan2, zhi2) {
    // 天干必须相同
    if (gan1 !== gan2) {
        return false;
    }
